...
<p><?php echo $show_message;?></p>
        <?php if($_G['forcemobilemessage']) { ?>
        	<p >
            	<a href="<?php echo $_G['setting']['mobile']['pageurl'];?>" class="mtn">ดำเนินการต่อไป</a><br />
                <a href="javascript:history.back();">ย้อนกลับ</a>
            </p>
        <?php } if($url_forward && !$_GET['loc']) { ?>
<!--<p><a class="grey" href="<?php echo $url_forward;?>">คลิกเพื่อข้ามไปหน้าถัดไป</a></p>-->
...
<p><input type="button" class="button" onclick="popup.close();" value="ปิด"></p>
<?php } ?>
</dt>
</div>
<?php } else { ?>
...
<p><a class="grey" href="<?php echo $url_forward;?>">คลิกเพื่อข้ามไปหน้าถัดไป</a></p>
<?php } elseif($allowreturn) { ?>
<p><a class="grey" href="javascript:history.back();">[ คลิกที่นี่เพื่อกลับไปยังเพจก่อนหน้า ]</a></p>
<?php } ?>
</div>
<!-- main jump end -->
