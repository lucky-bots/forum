...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1649486262, '', './data/template/__common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1649486262, '', './data/template/__common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1649486262, '', './data/template/__common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
;?>
...
<div class="xi1 bm bm_c">
    กรุณาเลือก <a href="<?php echo $_G['siteurl'];?>forum.php?mobile=yes">แสดงผลรูปแบบอุปกรณ์พกพา</a> <span class="xg1">|</span> <a href="<?php echo $_G['setting']['mobile']['nomobileurl'];?>">แสดงผลรูปแบบคอมพิวเตอร์</a>
</div>
<?php } if($_G['setting']['shortcut'] && $_G['member']['credits'] >= $_G['setting']['shortcut']) { ?>
<div id="shortcut">
<span><a href="javascript:;" id="shortcutcloseid" title="ปิด">ปิด</a></span>
If you visit <?php echo $_G['setting']['bbname'];?> frequently, Try to access to the desktop version for more convenience!
<a href="javascript:;" id="shortcuttip">To <?php echo $_G['setting']['bbname'];?> desktop version</a>
...
<a href="javascript:;" id="switchwidth" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>ขนาดปกติ<?php } else { ?>ขนาดจอกว้าง<?php } ?>" class="switchwidth"><?php if(widthauto()) { ?>ขนาดปกติ<?php } else { ?>ขนาดจอกว้าง<?php } ?></a>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">เปลี่ยนรูปแบบ</a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<li><a href="home.php?mod=space&amp;do=pm" id="pm_ntc" style="background-repeat: no-repeat; background-position: 0 50%;"><em class="prompt_news<?php if(empty($_G['member']['newpm'])) { ?>_0<?php } ?>"></em>ข้อความส่วนตัว</a></li>
<li><a href="home.php?mod=follow&amp;do=follower"><em class="prompt_follower<?php if(empty($_G['member']['newprompt_num']['follower'])) { ?>_0<?php } ?>"></em>ผู้ติดตาม<?php if($_G['member']['newprompt_num']['follower']) { ?>(<?php echo $_G['member']['newprompt_num']['follower'];?>)<?php } ?></a></li>
<?php if($_G['member']['newprompt'] && $_G['member']['newprompt_num']['follow']) { ?>
<li><a href="home.php?mod=follow"><em class="prompt_concern"></em>กำลังติดตาม(<?php echo $_G['member']['newprompt_num']['follow'];?>)</a></li>
...
<li class="ignore_noticeli"><a href="javascript:;" onclick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="แจ้งเตือนชั่วคราว"><em class="ignore_notice"></em></a></li>
<?php } ?>
</ul>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?>
<div id="sslct_menu" class="cl p_pop" style="display: none;">
<?php if(!$_G['style']['defaultextstyle']) { ?><span class="sslct_btn" onclick="extstyle('')" title="ค่าเริ่มต้น"><i></i></span><?php } if(is_array($_G['style']['extstyle'])) foreach($_G['style']['extstyle'] as $extstyle) { ?><span class="sslct_btn" onclick="extstyle('<?php echo $extstyle['0'];?>')" title="<?php echo $extstyle['1'];?>"><i style='background:<?php echo $extstyle['2'];?>'></i></span>
<?php } ?>
</div>
<?php } if($_G['uid']) { ?>
<ul id="myitem_menu" class="p_pop" style="display: none;">
<li><a href="forum.php?mod=guide&amp;view=my">โพสต์</a></li>
<li><a href="home.php?mod=space&amp;do=favorite&amp;view=me">บุ๊คมาร์ก</a></li>
<li><a href="home.php?mod=space&amp;do=friend">เพื่อน</a></li>
...
กรุณา<br /><a class="xi2" href="member.php?mod=connect"><strong>เชื่อมโยงบัญชีของคุณ</strong></a> หรือ <a href="member.php?mod=connect&amp;ac=bind" class="xi2 xw1"><strong>ผูกบัญชีการใช้งาน</strong></a><br /> เพื่อเข้าเยี่ยมชมโปรไฟล์
</div>
<?php } else { ?>
<div class="ptm pbw hm">
กรุณา <a href="javascript:;" class="xi2" onclick="lsSubmit()"><strong>ลงชื่อเข้าใช้</strong></a> เพื่อใช้งานเมนูเพิ่มเติม<br />ถ้าหากยังไม่มีแอคเคาท์กรุณา <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a>
</div>
...
<div id="nv">
<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">เมนูเพิ่มเติม</a>
...
$slist[forumfid] = <<<EOF
<li><a href="javascript:;" rel="curforum" fid="{$_G['fid']}" >บอร์ดนี้</a></li>
EOF;
?><?php } if($_G['setting']['portalstatus'] && $_G['setting']['search']['portal']['status'] && ($_G['group']['allowsearch'] & 1 || $_G['adminid'] == 1)) { ?><?php
$slist[portal] = <<<EOF
<li><a href="javascript:;" rel="article">บทความ</a></li>
EOF;
?><?php } if($_G['setting']['search']['forum']['status'] && ($_G['group']['allowsearch'] & 2 || $_G['adminid'] == 1)) { ?><?php
$slist[forum] = <<<EOF
<li><a href="javascript:;" rel="forum" class="curtype">กระทู้</a></li>
EOF;
?><?php } if(helper_access::check_module('blog') && $_G['setting']['search']['blog']['status'] && ($_G['group']['allowsearch'] & 4 || $_G['adminid'] == 1)) { ?><?php
$slist[blog] = <<<EOF
<li><a href="javascript:;" rel="blog">บล็อก</a></li>
EOF;
?><?php } if(helper_access::check_module('album') && $_G['setting']['search']['album']['status'] && ($_G['group']['allowsearch'] & 8 || $_G['adminid'] == 1)) { ?><?php
$slist[album] = <<<EOF
<li><a href="javascript:;" rel="album">อัลบั้ม</a></li>
EOF;
...
?><?php } ?><?php
$slist[user] = <<<EOF
<li><a href="javascript:;" rel="user">สมาชิก</a></li>
EOF;
?>
...
<strong class="xw1">แท็กยอดนิยม: </strong><?php if(is_array($_G['setting']['srchhotkeywords'])) foreach($_G['setting']['srchhotkeywords'] as $val) { if($val=trim($val)) { $valenc=rawurlencode($val);?><?php
